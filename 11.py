...
for i in range(0, c - 3):
    for j in range(0, c - 3):
        n1 = b[i+j*c] * b[i+1+j*c] * b[i+2+j*c] * b[i+3+j*c]
        n2 = b[i+j*c] * b[i+c+j*c] * b[i+2*c+j*c] * b[i+3*c+j*c]
        n3 = b[i+j*c] * b[i+c+1+j*c] * b[i+2*c+2+j*c] * b[i+3*c+3+j*c]
        n4 = b[i+3+j*c] * b[i+c+2+j*c] * b[i+2*c+1+j*c] * b[i+3*c+j*c]
        num.append(n1)
        num.append(n2)
        num.append(n3)
        num.append(n4)
